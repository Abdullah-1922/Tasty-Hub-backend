...
router.patch("/follow", auth(USER_ROLE.user,USER_ROLE.admin), UserController.followUser);
router.patch("/unfollow", auth(USER_ROLE.user,USER_ROLE.admin), UserController.unFollowUser);
